 ...
 *     <li>PUT /api/brags/{id} - Update existing brag log (exclude STUDENT role)</li>
 *     <li>DELETE /api/brags/{id} - Delete existing brag log (exclude STUDENT role)</li>
 * </ul>
 *
 * <p>Security:
 * <ul>
 ...
 *     <li>PUT, DELETE endpoints - ADMIN, TEACHER, PARA, or STAFF role required</li>
 * </ul>
 *
 * @version 2.4
 * @author Dylan Mercer
...
public class BragLogController {
     ...
     */
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'TEACHER', 'STAFF', 'PARA')")
